  ...
  return (
    <>
      <Image
        ...
        quality="100"
      />
      <h3 className="my-4 text-3xl font-medium tracking-wider font-marker">
        Igor Cotrim
      </h3>
      ...
      <div className="flex justify-around w-9/12 mx-auto my-5 text-indigo md:w-full">
        <a href="https://github.com/igor-cotrim" target="_blank" aria-label="Github">
          <AiFillGithub className="w-8 h-8 cursor-pointer" />
        </a>
        <a href="https://www.linkedin.com/in/igorcotrim/" target="_blank" aria-label="Linkedin">
