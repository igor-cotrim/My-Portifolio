...
export const projects: IProject[] = [
  {
    ...
    name: "Netflix Clone",
    description:
      "Clone da pagina inicial da Netflix feita com React. Usando a API externa da Themoviedb.org para obeter as informações dos filmes/series.",
  ...
  },
  {
    ...
    name: "Twitter Clone",
    description:
      "Clone da home do Twitter feita com React. Fiz esse clone para testar meus conhecimentos com React e começar a utilizar Typescript nas minhas aplicações. Alem de usar o CSS-in-JS com o styled-components.",
  ...
  },
  {
    ...
    name: "Layout Pizza",
    description:
      "Esse layout fiz para treinar meus conhecimentos sobre HTML, CSS e Javascript. 😉😎",
  ...
  },
  {
    ...
    name: "Move-it",
    description:
      "Um pomodoro feito com nextjs. Fiz essa aplicação durante a Next Level Week e foi aqui que aprendi o poder que o nextjs tem!",
  ...
  },
  {
    ...
    name: "Github Clone",
    description:
      "Clone da home do Github feita com React. Fiz essa aplicação para treinar meus conhecimentos com React e Typescript. Usando a API do Github para puxar alguns dados como, followers, following, repositories, empresa, cidade, contato e foto. Um darkMode (clique no icone do Github e veja a magica acontecer!) e se pode pesquisar por usuário ou repositórios.",
  ...
  },
  {
    ...
    description:
      "Clone do chat do Whatsapp feita com React. Fiz essa aplicação para treinar meus conhecimentos com React e Javascript. O maior desafio nessa aplicação foi integrar com o firebase, uma ferramenta que nunca tinha mexido. Lendo documentações e dando muito google consegui! Ps: Não consegui fazer o deploy por causa do firebase, mas logo logo estará ai. 😄",
  ...
  },
  {
    ...
    name: "Spotify Clone",
    description:
      "Clone da home do Spotify feita com React. Fiz essa aplicação para treinar meus conhecimentos com React e Javascript. Essa aplicação foi um grande desafio para mim porque além de usar o firebase (que não sabia muito bem usar) e ainda consumir a API do Spotify. Ficou uma aplicação estática podendo implementar muitas funcionalidades futuramente, deixando mais linda e com funcionalidades. Ps: Não consegui fazer o deploy por causa do firebase, mas logo logo estará ai. 😄",
  ...
  },
  {
    ...
    description:
      "Um repositório com varias aplicações usando JavaScript Vanilla HTML e CSS so para treinar meus conhecimentos 😉",
  ...
  },
  {
    ...
    name: "Proffy",
    description:
      "Proffy - é uma forma de conectar alunos e professores em uma plataforma de estudos online. Foi feito durante a NLW (Next Level Week) uma semana de muitos conhecimentos e mão na massa! Nessa semana tive contato com muitas tecnologias e foi de grande valia para minha carreia. Obrigado Rocketseat!",
  ...
  },
  {
    ...
    name: "ignews",
    description:
      "ignews um plataforma de assinatura de posts usando nextjs. Para aprender como o nextjs funciona e como usar o prismic para fazer posts no blog. Feito durante o ignite, foi um projeto em que aprendi muitos fundamentos do nextjs e soluções para back-end dentro do front-end, foi interessante e uma ótima experiência de aprendizado!",
    image_path: "/images/ignews.jpg",
    github_url: "https://github.com/igor-cotrim/ignews",
  ...
  },
  {
    ...
    image_path: "/images/dtmoney.jpg",
    github_url: "https://github.com/igor-cotrim/dtMoney",
    category: ["react"],
    key_techs: [
      "React",
      "Miragejs",
